...
<body>
  <div class="container">
    ...
    <p class="message">
      We are pleased to inform you that your parcel has been successfully delivered to <span class="highlight">' . htmlspecialchars($township) . '</span>.
    </p>
    <p class="message">
  ...
  public static function deliverysuccessforreceiver($email, $name, $tracking_code, $township)
  {
    ...
    try {
      ...
      $mail->addAddress($email);
      $mail->isHTML(true);
      $mail->Subject = 'GoDelivery - Your Parcel is Ready for Pickup';
      ...
      <body>
        <div class="container">
          <div class="logo">GO<span>DELIVERY</span></div>
          <div class="header">Your Parcel Has Arrived</div>
          <p class="message">Dear <span class="highlight">' . htmlspecialchars($name) . '</span>,</p>
          <p class="message">
            We are pleased to inform you that your delivery with tracking code 
            <span class="highlight">' . htmlspecialchars($tracking_code) . '</span> has successfully arrived 
            at our GoDelivery office in <span class="highlight">' . htmlspecialchars($township) . '</span>.
          </p>
          <p class="message">
            You can now visit our office during working hours to collect your parcel.
          </p>
          <p class="message">Please bring your tracking code or a valid ID for verification.</p>
          <div class="code-box">Tracking Code: ' . htmlspecialchars($tracking_code) . '</div>
          <p class="message">
            Thank you for using <strong>GoDelivery</strong>. We look forward to serving you again!
          </p>
          <div class="footer">&copy; ' . date('Y') . ' GoDelivery. All rights reserved.</div>
        </div>
      </body>
      ...
      <body>
        <div class="container">
          ...
          <p class="message">
            ...
            <span class="highlight">' . htmlspecialchars($tracking_code) . '</span> to the intended recipient in 
            <span class="highlight">' . htmlspecialchars($township) . '</span>.
          </p>
          <p class="message">
            Our delivery agent attempted to contact the receiver, but they were unreachable and did not collect the parcel. 
            As a result, the item has been returned to our office <span class="highlight">'. htmlspecialchars($from_township) . '</span>.
          </p>
          <div class="code-box">Tracking Code: ' . htmlspecialchars($tracking_code) . '</div>
          <p class="message">
            You may retrieve the parcel from our office at your convenience. Please bring the tracking code or sender ID 
            for verification.
          </p>
          <p class="message">
            We apologize for any inconvenience caused and appreciate your understanding.
          </p>
          <p class="message">Thank you for choosing <strong>GoDelivery</strong>.</p>
          <div class="footer">&copy; ' . date('Y') . ' GoDelivery. All rights reserved.</div>
        </div>
      </body>
      </html>';
