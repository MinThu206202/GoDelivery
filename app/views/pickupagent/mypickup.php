                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?= htmlspecialchars($pick['sender_address']) ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex space-x-2">
                                    <a href="<?= URLROOT; ?>/pickupagentcontroller/pickupdetail?request_code=<?= htmlspecialchars($pick['request_code']); ?>"
                                        class="px-3 py-1 bg-blue-500 text-white text-xs font-semibold rounded hover:bg-blue-600 w-auto">View</a>
                                    <?php if ($pick['status'] === 'accepted'): ?>
                                    <a href="<?= URLROOT; ?>/pickupagentcontroller/startpickup?id=<?= htmlspecialchars($pick['id']); ?>"
                                        class="px-3 py-1 bg-green-500 text-white text-xs font-semibold rounded hover:bg-green-600 w-auto">Pickup</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
