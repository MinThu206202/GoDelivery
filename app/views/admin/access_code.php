...
<div class="settings-overlay" id="settingsOverlay" style="text-align:left; display: none;">
    <div class="settings-box">
        ...
        <div id="accessCodeData">
            ...
            <p><strong><i class="fas fa-info-circle"></i> Status:</strong> <span id="detailStatus" class="status-label"></span></p>
        </div>
        <div class="settings-actions">
            <button class="detail-button" type="button" id="sendEmailButton"><i class="fas fa-envelope"></i> Send Email</button>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function filterTable() {
            ...
            if (visibleCount === 0) {
                ...
                noDataTr.innerHTML = `<td colspan="7" style="text-align:center; font-weight:bold;">Data is not available</td>`;
