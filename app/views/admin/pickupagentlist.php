   ...
   <main class="flex-1 p-6 space-y-6 md:ml-64">
       ...
       <header class="bg-white p-4 rounded-lg shadow-md flex items-center justify-between">
           <div class="flex items-center space-x-2">
               ...
               <h2 class="text-xl font-semibold text-gray-800">Pickup Agent </h2>
           </div>
           <div class="flex items-center space-x-2">
       ...
       <div class="bg-white p-6 rounded-lg shadow-md">
           <div class="flex justify-between items-center mb-4">
               <h3 class="text-xl font-semibold text-gray-800">Pickup Agent List</h3>
               <button onclick="window.location='<?= URLROOT; ?>/admin/agent';"
                   ...
                   <table class="w-full text-left table-auto border-collapse">
                       <thead class="sticky top-0 z-10 bg-custom-blue">
                           <tr>
                               ...
                               <th class="px-4 py-3 font-medium text-white text-sm">Created By Agnet</th>
                       ...
                       <tbody class="divide-y divide-gray-200">
                           <?php if (!empty($data['pickupagent'])): ?>
                           <?php foreach ($data['pickupagent'] as $agent): ?>
                           <tr class="hover:bg-gray-50">
                               ...
                               <td class="px-4 py-3 text-sm text-gray-800">
                                   <?= htmlspecialchars($agent['created_by_agent_name'] ?? 'N/A') ?></td>
                               ...
                               <td class="px-4 py-3 text-sm">
                                   <a href="<?php echo URLROOT; ?>/admincontroller/pickupagentdetail?id=<?php echo $agent['id']; ?>"
