    ...
    <main class="flex-1 overflow-y-auto p-6 bg-gray-100">
        ...
        <div class="max-w-xl mx-auto bg-white p-8 rounded-xl shadow-md">
            ...
            <div class="space-y-4 mb-8">
                ...
                <div>
                    <label for="statusNotes" class="block text-sm font-medium text-gray-700 mb-1">Notes
                        (Optional):</label>
                    <textarea required id="statusNotes" rows="3"
            ...
            <div class="flex justify-end space-x-4 mt-6">
                <button type="button" onclick="window.location.href='<?= URLROOT ?>/agent/incoming';"
...
<!-- Hidden POST form -->
<form id="postStatusForm" method="POST" action="<?= URLROOT ?>/agentcontroller/show_updated_status_income"
    style="display: none;">
