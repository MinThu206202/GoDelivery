        ...
        <main class="flex-1 overflow-y-auto p-6 bg-gray-100">
            <div class="max-w-xl mx-auto bg-white p-8 rounded-xl shadow-md">
                ...
                <form id="addAgentForm" class="space-y-6" method="POST"
                    ...
                    <div>
                        <label for="assignedVehicle" class="block text-sm font-medium text-gray-700">Assigned Vehicle
                            (optional)</label>
                    ...
                    <!-- Vehicle Number -->
                    <div>
                        <label for="vehicleNumber" class="block text-sm font-medium text-gray-700">Vehicle
                            Number</label>
